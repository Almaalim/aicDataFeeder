                                        ...
                                        <center style="height: 187px">
                                            ...
                                            <table cellspacing="10" dir="ltr" style="border: thick double #800000; height: 21px; width: 470px;" bgcolor="#FFFBD6">
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtCurrentPass" runat="server" CssClass="txtbox" Width="250px" TextMode="Password"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtNewPass" runat="server" TextMode="Password" CssClass="txtbox" Width="250px" ></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <asp:TextBox ID="txtConfirmPass" runat="server" TextMode="Password" CssClass="txtbox" Width="250px" ></asp:TextBox>
