                                    ...
                                    <table width="100%">      
                                        <tr class="td2Allalign">
                                            <td  colspan="4" class="collapsePanelButtonBorder">
                                                <asp:Button ID="btnMainAdd"    runat="server" Text="Add" CssClass="ActionButton" onclick="btnMainAdd_Click"/>
                                                &nbsp;&nbsp;
                                                <asp:Button ID="btnMainEdit"   runat="server" Text="Edit" CssClass="ActionButton" Enabled="False" onclick="btnMainEdit_Click" />
                                                &nbsp;&nbsp;
                                                <asp:Button ID="btnMainDelete" runat="server" Text="Delete" CssClass="ActionButton" Enabled="False" onclick="btnMainDelete_Click" />
                                                &nbsp;&nbsp;
                                                <asp:Button ID="btnMainSave"   runat="server" Text="Save" CssClass="ActionButton" Enabled="False" onclick="btnMainSave_Click"  ValidationGroup="vgSave"/>
                                                &nbsp;&nbsp;
                                                <asp:Button ID="btnMainCancel" runat="server" Text="Cancel" CssClass="ActionButton" Enabled="False" onclick="btnMainCancel_Click" />
                                                &nbsp;&nbsp;
                                        ...
                                        <tr class="td2Allalign">
                                            ...
                                            <td class="td2Allalign">
                                                <asp:TextBox ID="txtDepNameAr" runat="server" Enabled="False" Width="168"></asp:TextBox>
                                                <asp:CustomValidator id="cvDepNameAr" runat="server" ValidationGroup="vgSave" OnServerValidate="DepName_ServerValidate"
                                                    Text="&lt;img src='Images/icon/Exclamation.gif' title='Department Name (Ar) is required!' /&gt;" 
                                            ...
                                            <td class="td2Allalign">
                                                <asp:TextBox ID="txtDepNameEn" runat="server" Enabled="False" Width="168"></asp:TextBox>
                                                <asp:CustomValidator id="cvDepNameEn" runat="server" ValidationGroup="vgSave" OnServerValidate="DepName_ServerValidate"
                                        ...
                                        <tr class="td2Allalign">
                                            ...
                                            <td class="td2Allalign" colspan="2">
                                                <asp:DropDownList ID="ddlParentID" runat="server" Width="350px"></asp:DropDownList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="td2Allalign">
                                            ...
                                            <td class="td2Allalign" colspan="3">
                                                <asp:TextBox ID="txtDepDesc" runat="server" Width="713px" Enabled="False"></asp:TextBox>
