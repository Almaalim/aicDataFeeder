...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlMain" runat="server" DefaultButton="btnSave" meta:resourcekey="pnlMainResource1">
                <div id="pageDiv" runat="server" class="td2Allalign">
                    ...
                    <div class="row">
                        ...
                        <div class="col3">
                            <asp:DropDownList ID="ddlAppCalendar" runat="server" Width="173px" meta:resourcekey="ddlAppCalendarResource1">
                                <asp:ListItem Text="-Select Calendar-" Value="0" meta:resourcekey="ListItemResource1"></asp:ListItem>
                            ...
                            <asp:RequiredFieldValidator ID="rvddlAppCalendar" runat="server" ControlToValidate="ddlAppCalendar" CssClass="CustomValidator"
                                ...
                                ValidationGroup="vgSave" InitialValue="0" meta:resourcekey="rvddlAppCalendarResource1"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col12">
                    ...
                    <div class="row">
                        <div class="col12">
                            <asp:LinkButton ID="btnSave" runat="server" CssClass="GenButton glyphicon glyphicon-floppy-disk" Text="Save" OnClick="btnSave_Click" ValidationGroup="vgSave" Width="80px" meta:resourcekey="btnSaveResource1"></asp:LinkButton>
                            <asp:LinkButton ID="btnCancel" runat="server" CssClass="GenButton glyphicon glyphicon-remove-circle" Text="Cancel" OnClick="btnCancel_Click" Width="80px" meta:resourcekey="btnCancelResource1"></asp:LinkButton>
                    ...
                    <div class="row">
                        <div class="col12">
                            <asp:ValidationSummary ID="vsSave" runat="server" CssClass="MsgValidation"
                                EnableClientScript="False" ValidationGroup="vgSave" meta:resourcekey="vsSaveResource1" />
