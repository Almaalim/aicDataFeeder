...
public class StickersPro
{
    ...
    public string StickerID { get { return _StickerID; } set { _StickerID = value; } }

    private string _RegVehicle;
    public string RegVehicle { get { return _RegVehicle; } set { _RegVehicle = value; } }
