...
public static class InfoTab
{
    ...
    public static string FindPageInfo(int pIndex, string pInfo)
    {
        try
        {
            ...
            if (pIndex == 1) { PageName = "Home"; PageTitel = General.Msg("Home", "البداية"); PageUrl = @"~/Pages/Home.aspx"; }
            if (pIndex == 2) { PageName = "Users"; PageTitel = General.Msg("Users", "المستخدمون"); PageUrl = @"~/Pages/UsrHome.aspx"; }
            if (pIndex == 3) { PageName = "Employees"; PageTitel = General.Msg("Employees", "الموظفون"); PageUrl = @"~/Pages/Employee.aspx"; }
            if (pIndex == 4) { PageName = "Departments"; PageTitel = General.Msg("Departments", "الأقسام"); PageUrl = @"~/Pages/DepartmentHome.aspx"; }
            if (pIndex == 5) { PageName = "Vacations"; PageTitel = General.Msg("Vacations", "الإجازات"); PageUrl = @"~/Pages/VacationHome.aspx"; }
