...
public class FormCtrl
{
    ...
    
    static public void GridSelectedRow(Page pg, GridView gv, GridViewRow gr)
    {
        try
        {
            if (gr.RowType == DataControlRowType.DataRow)
            {
                gr.Attributes["onclick"] = pg.ClientScript.GetPostBackClientHyperlink(gv, "Select$" + gr.RowIndex);
            }
        }
        catch (Exception EX) { }
    }
