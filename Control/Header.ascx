...
<%--<asp:LinkButton ID="lnkChangeLang" runat="server" OnClick="lnkChangeLang_Click" Height ="16px" 
                                        ImageUrl="~/App_Themes/ThemeEn/images/english_icon.png" 
                                        meta:resourcekey="lnkChangeLangResource1"></asp:LinkButton>--%>
...
<%--<asp:LinkButton ID="lnkChangePassword" runat="server" OnClick="lnkChangePassword_Click" Height ="16px" 
                                        ImageUrl="~/App_Themes/ThemeEn/images/Control/ChangePass16.png" 
                                        meta:resourcekey="lnkChangePasswordResource1"></asp:LinkButton>--%>
...
<%--<asp:LinkButton ID="lnkLogout" runat="server" OnClick="lnkLogout_Click" Height ="16px" 
                                        ImageUrl="~/App_Themes/ThemeEn/images/logout16.png" 
                                        meta:resourcekey="lnkLogoutResource1"></asp:LinkButton>--%>
