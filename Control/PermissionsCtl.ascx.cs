        ...
        foreach (Control ctrl in con.Controls)
        {
            if (ctrl is CheckBoxList)
            {
                ...
                if (CBL != null)
                {
                    ...
                    {
                        if (CBL.ID.Contains("cblHome") && !permStr.ToString().Contains(",Home")) { permStr.Append(",Home"); }
                        if (CBL.ID.Contains("cblUsr") && !permStr.ToString().Contains(",Users")) { permStr.Append(",Users"); }
                        if (CBL.ID.Contains("cblEmp") && !permStr.ToString().Contains(",Employees")) { permStr.Append(",Employees"); }
                        if (CBL.ID.Contains("cblDep") && !permStr.ToString().Contains(",Departments")) { permStr.Append(",Departments"); }
                        if (CBL.ID.Contains("cblVac") && !permStr.ToString().Contains(",Vacations")) { permStr.Append(",Vacations"); }
                        //if (CBL.ID.Contains("cblEmpVac") && !permStr.ToString().Contains(",EmpVacation")) { permStr.Append(",EmpVacation"); }
                        if (CBL.ID.Contains("cblMac") && !permStr.ToString().Contains(",Machines")) { permStr.Append(",Machines"); }
                        if (CBL.ID.Contains("cblSet") && !permStr.ToString().Contains(",Settings")) { permStr.Append(",Settings"); }
